...
// Each stage: mandatory inverter + optional 3-inverter delay path via MUX.
...
module ring_osc_dco (
    ...
    sg13g2_inv_1 u_dc_0  (.A(delay_b[0]),  .Y(delay_c[0]));
    ...
    sg13g2_inv_1 u_dc_1  (.A(delay_b[1]),  .Y(delay_c[1]));
    ...
    sg13g2_inv_1 u_dc_2  (.A(delay_b[2]),  .Y(delay_c[2]));
    ...
    sg13g2_inv_1 u_dc_3  (.A(delay_b[3]),  .Y(delay_c[3]));
    ...
    sg13g2_inv_1 u_dc_4  (.A(delay_b[4]),  .Y(delay_c[4]));
    ...
    sg13g2_inv_1 u_dc_5  (.A(delay_b[5]),  .Y(delay_c[5]));
    ...
    sg13g2_inv_1 u_dc_6  (.A(delay_b[6]),  .Y(delay_c[6]));
